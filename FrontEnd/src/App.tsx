...
function App() {
    ...
    const getUrlParams = () => {
        ...
        return {
            ...
            type: urlParams.get("type") as "agent" | "user" | null,
    ...
    const autoLoginFromUrl = async () => {
        ...
        if (params.email && params.password && params.type) {
            try {
                ...
                setView(params.type === "agent" ? "agent" : "widget");
                ...
                <div className="bg-yellow-100 border-b border-yellow-200 px-4 py-2">
                    <div className="max-w-7xl mx-auto flex items-center justify-center space-x-2">
                        ...
                        <span className="text-sm font-medium text-yellow-800">
                            Demo Mode Active - Using dummy data and simulated
                            responses
                        </span>
                    </div>
                </div>
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="text-center mb-12">
                    ...
                    <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                        A fully-featured React.js chat system with real-time
                        messaging, file uploads, voice messages, and Laravel
                        backend integration using Reverb WebSockets.
                    </p>
                    {isDemoMode && (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                    <div className="bg-white rounded-xl shadow-sm p-6 border">
                        ...
                        <p className="text-gray-600">
                            Instant messaging with typing indicators, read
                            receipts, and WebSocket connections.
                        </p>
                    </div>
                    ...
                    <div className="bg-white rounded-xl shadow-sm p-6 border">
                        ...
                        <p className="text-gray-600">
                            Complete agent dashboard with chat management, user
                            info, and queue handling.
                        </p>
                    </div>
                    ...
                    <div className="bg-white rounded-xl shadow-sm p-6 border">
                        ...
                        <p className="text-gray-600">
                            File uploads, image sharing, voice messages, and
                ...
                <div className="bg-white rounded-xl shadow-sm p-8 border">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-600">
                            Experience the chat system from both customer and
                            agent perspectives. The chat widget will appear in
                        ...
                        <div className="space-y-4">
                            ...
                            <ul className="space-y-2 text-gray-600">
                                ...
                                <li className="flex items-center space-x-2">
                                    <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                                    <span>
                                        See queue position and agent status
                                    </span>
                                </li>
                            </ul>
                        </div>
                        ...
                        {isDemoMode && (
                            <div className="mb-4 p-3 bg-blue-50 rounded border border-blue-200">
                                <p className="text-sm text-blue-800">
                                    Demo credentials are pre-filled. Click
                                    "Login" to continue.
                                </p>
                            </div>
                        )}
