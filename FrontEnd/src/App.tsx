        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-xl font-bold text-gray-900">SupportChat</span>
              {isDemoMode && (
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            A fully-featured React.js chat system with real-time messaging, file uploads, 
            voice messages, and Laravel backend integration using Reverb WebSockets.
          </p>
          {isDemoMode && (
            <div className="mt-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div className="bg-white p-3 rounded border">
                  <strong className="text-blue-800">Agent Login:</strong><br />
                  Email: {import.meta.env.VITE_DEMO_AGENT_EMAIL || 'agent@demo.com'}<br />
                  Password: {import.meta.env.VITE_DEMO_AGENT_PASSWORD || 'agent123'}
                </div>
                <div className="bg-white p-3 rounded border">
                  <strong className="text-blue-800">User Login:</strong><br />
                  Email: {import.meta.env.VITE_DEMO_USER_EMAIL || 'user@demo.com'}<br />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          <div className="bg-white rounded-xl shadow-sm p-6 border">
            ...
            <p className="text-gray-600">
              Instant messaging with typing indicators, read receipts, and WebSocket connections.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Agent Console</h3>
            <p className="text-gray-600">
              Complete agent dashboard with chat management, user info, and queue handling.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Rich Media Support</h3>
            <p className="text-gray-600">
              File uploads, image sharing, voice messages, and clipboard paste support.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-8 border">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Experience the chat system from both customer and agent perspectives. 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-gray-900">Customer Features</h3>
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-gray-900">Agent Features</h3>
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-center space-x-2">
